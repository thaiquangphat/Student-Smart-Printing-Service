...
import TableRow1 from "./thong-tin-in-table/thongtinintable1.component";
                ...
                {dataArr.map(
                  (data) =>
                    filter(data, filterString) && (
                      <TableRow1 data={data} key={data["id"]} />
                    )
                )}
              </tbody>
            </table>
...
export default NhanGiaoDichIn1;
